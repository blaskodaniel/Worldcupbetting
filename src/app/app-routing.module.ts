...
const appRoutes:Routes = [
    ...
    {path:'download', component:DownloadpageComponent, canActivate:[GuardService]},
    {path:'team/:id', component:TeamdataComponent},
    {path:'profile',component:ProfileComponent, canActivate:[GuardService]},
    {path:'toplist',component:MaintoplistComponent, canActivate:[GuardService]},
    {path:'userbets/:id',component:UserbetsComponent, canActivate:[GuardService]},
    ...
    {path:'userteams', component:UserteamsComponent, canActivate:[GuardService,EditorGuardService]},
